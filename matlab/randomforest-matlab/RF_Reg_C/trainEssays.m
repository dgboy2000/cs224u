...
% X_trn = readmtx('data/features/features.set1.train',895,60,'%g');
% Y_trn = readTextFile('data/features/grades.set1.train');
% Y_trn  = str2double(Y_trn);
% X_tst = readmtx('data/features/features.set1.test',888,60,'%g');
% Y_tst = readTextFile('data/features/grades.set1.test');
% Y_tst  = str2double(Y_tst);

d = 2
X_trn = readTextFile(['data/features/features.set' num2str(d) '.train'],1);
Y_trn = readTextFile(['data/features/grades.set' num2str(d) '.train']);
Y_trn  = str2double(Y_trn);

X_tst = readTextFile(['data/features/features.set' num2str(d) '.test'],1);
Y_tst = readTextFile(['data/features/grades.set' num2str(d) '.test']);
Y_tst  = str2double(Y_tst);
